...
}),has:d(function(key){return-1!==eIndexOf.call(this.__mapKeysData__,key)}),keys:d(function(){return new Iterator(this,"key")}),set:d(function(key,value){var emit,index=eIndexOf.call(this.__mapKeysData__,key);return-1===index&&(index=this.__mapKeysData__.push(key)-1,emit=!0),this.__mapValuesData__[index]=value,emit&&this.emit("_add",index,key),this}),size:d.gs(function(){return this.__mapKeysData__.length}),values:d(function(){return new Iterator(this,"value")}),toString:d(function(){return"[object Map]"})})),Object.defineProperty(MapPoly.prototype,Symbol.iterator,d(function(){return this.entries()})),Object.defineProperty(MapPoly.prototype,Symbol.toStringTag,d("c","Map"))},{"./is-native-implemented":4,"./lib/iterator":6,d:8,"es5-ext/array/#/clear":9,"es5-ext/array/#/e-index-of":10,"es5-ext/object/set-prototype-of":31,"es5-ext/object/valid-callable":34,"es5-ext/object/valid-value":35,"es6-iterator/for-of":41,"es6-iterator/valid-iterable":46,"es6-symbol":47,"event-emitter":50}],52:[function(require,module){"use strict";function ToObject(val){if(null==val)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(val)}module.exports=Object.assign||function(target){for(var pendingException,from,keys,to=ToObject(target),s=1;s<arguments.length;s++){from=arguments[s],keys=Object.keys(Object(from));for(var i=0;i<keys.length;i++)try{to[keys[i]]=from[keys[i]]}catch(err){void 0===pendingException&&(pendingException=err)}}if(pendingException)throw pendingException;return to}},{}],53:[function(require,module){"use strict";var Dispatch=function(payload){this.payload=payload,this.isPending={},this.isHandled={}};$traceurRuntime.createClass(Dispatch,{dispatchToTable:function(id,table){var $__1=this.payload,action=$__1.action,params=$__1.params;table.has(action)&&(this.isPending[id]=!0,table.get(action).call(action,params),this.isHandled[id]=!0,this.isPending[id]=!1)}},{}),module.exports=Dispatch},{}],54:[function(require,module){"use strict";function proxy(dest,src,methods){methods.forEach(function(method){src[method]&&(dest[method]=function(){return src[method].apply(src,arguments)})})}var Map=require("es6-map"),assign=require("object-assign"),DispatchTable=function(handlers,spec){this.handlers=new Map(handlers),proxy(this,this.handlers,["has","get","clear"]),assign(this,spec)};$traceurRuntime.createClass(DispatchTable,{},{}),module.exports=DispatchTable},{"es6-map":2,"object-assign":52}],55:[function(require,module){"use strict";var invariant=(require("es6-map"),require("./lib/invariant")),warning=require("./lib/warning"),Dispatch=require("./Dispatch"),createActions=require("./lib/createActions"),lastId=1,IS_DISPATCHING=!1,dispatchTables={},Dispatcher=function(){this.queue=[]};$traceurRuntime.createClass(Dispatcher,{register:function(table){var id="id"+ ++lastId;return dispatchTables[id]=table,id},unregister:function(id){invariant(dispatchTables[id],"Dispatcher.unregister(...): "+id+" does not map to a registered dispatch table."),dispatchTables[id].clear(),delete dispatchTables[id]},isDispatching:function(){return IS_DISPATCHING},createActions:function(spec){return createActions(spec,this)},waitFor:function(){for(var ids=[],$__2=0;$__2<arguments.length;$__2++)ids[$__2]=arguments[$__2];var $__0=this;invariant(IS_DISPATCHING||!this.currentDispatch,"Dispatcher.waitFor(...): Cannot call waitFor while not currently dispatching."),ids.forEach(function(id){return $__0.currentDispatch.isPending[id]?void invariant($__0.currentDispatch.isPending[id],"Dispatcher.waitFor(...): Circular dependency detected while waiting for "+id):(invariant(dispatchTables[id],"Dispatcher.waitFor(...): "+id+" does not map to a registered dispatch table."),void $__0.currentDispatch.dispatchToTable(id,dispatchTables[id]))})},dispatch:function(action,params){var $__0=this;return this.isDispatching()?(warning(!this.isDispatching(),"Dispatcher.dispatch(...): Cascading dispatch detected. \n"+("You have tried to dispatch an action of type '"+action.displayName()+"' while simultaneously dispatching an action of type '"+this.currentDispatch.payload.action.displayName()+"'. ")+"This action will be queued until the pending payload has finished dispatching. Actions should avoid cascading updates wherever possible."),this.queueDispatch(action,params)):void this.startDispatch(action,params,function(currentDispatch){IS_DISPATCHING=!0,$__0.currentDispatch=currentDispatch;try{for(var id in dispatchTables)currentDispatch.dispatchToTable(id,dispatchTables[id])}finally{IS_DISPATCHING=!1,$__0.currentDispatch=null,$__0.flushQueue()}})},queueDispatch:function(action,params){this.isDispatching()||this.dispatch(action,params),this.queue.push({action:action,params:params})},flushQueue:function(){for(var queued;queued=this.queue.pop();)this.dispatch(queued.action,queued.params)},startDispatch:function(action,params,cb){cb(new Dispatch({action:action,params:params}))}},{}),module.exports=Dispatcher},{"./Dispatch":53,"./lib/createActions":59,"./lib/invariant":63,"./lib/warning":65,"es6-map":2}],56:[function(require,module){"use strict";var EventEmitter=require("events").EventEmitter,invariant=require("./lib/invariant"),$__3=require("./lib/storeHelpers"),setPending=$__3.setPending,resolve=$__3.resolve,createDispatchTable=require("./lib/createDispatchTable"),CHANGE_EVENT="change",BaseStore=function(){this.displayName||(this.displayName="Store")};$traceurRuntime.createClass(BaseStore,{emitChange:function(){this.emit(CHANGE_EVENT)},addChangeListener:function(cb){this.on(CHANGE_EVENT,cb)},removeChangeListener:function(cb){this.removeListener(CHANGE_EVENT,cb)},setPending:function(){setPending(this)},resolve:function(){resolve(this)},handlers:function(){for(var handlers=[],$__1=0;$__1<arguments.length;$__1++)handlers[$__1]=arguments[$__1];return arguments.length?void(this.dispatchTable=createDispatchTable(handlers,this.displayName)):(invariant(this.dispatchTable,this.displayName+".handlers(): No handlers have been declared."),this.dispatchTable)}},{},EventEmitter),module.exports=BaseStore},{"./lib/createDispatchTable":61,"./lib/invariant":63,"./lib/storeHelpers":64,events:1}],57:[function(require,module){"use strict";var createAction=require("./lib/createAction"),anyPending=require("./lib/storeHelpers").anyPending,fluent={Dispatcher:require("./Dispatcher"),createStore:require("./lib/createStore"),handler:require("./lib/createDispatchRecord"),anyPending:anyPending,ALL_ACTIONS:createAction(function(){},"ALL_ACTIONS")};module.exports=fluent},{"./Dispatcher":55,"./lib/createAction":58,"./lib/createDispatchRecord":60,"./lib/createStore":62,"./lib/storeHelpers":64}],58:[function(require,module){"use strict";module.exports=function(fn,name,dispatcher){var functor=function(){fn.apply(functor,arguments)};return functor.displayName=function(){return name},functor.dispatch=function(params){dispatcher.dispatch(functor,params)},functor}},{}],59:[function(require,module){"use strict";var createAction=require("./createAction");module.exports=function(actions,dispatcher){var definition={};for(var method in actions)definition[method]=createAction(actions[method],method,dispatcher);return definition}},{"./createAction":58}],60:[function(require,module){"use strict";var invariant=require("./invariant");module.exports=function(action,handler){return invariant(action,"handler(...): You have tried to create a dispatch handler with a null or undefined Action type - this is usually an error."),[action,handler]}},{"./invariant":63}],61:[function(require,module){"use strict";var invariant=require("./invariant"),DispatchTable=require("../DispatchTable"),TablePostfix="_DispatchTable";module.exports=function(handlers,displayName){handlers&&handlers.length||invariant(!1,"createDispatchTable(...): Store "+store.displayName+" has not declared any handlers.");var spec={displayName:(displayName?displayName:"")+TablePostfix};return new DispatchTable(handlers,spec)}},{"../DispatchTable":54,"./invariant":63}],62:[function(require,module){"use strict";var BaseStore=require("../Store"),assign=require("object-assign");module.exports=function(spec){var Store=function(){$traceurRuntime.defaultSuperCall(this,$Store.prototype,arguments)},$Store=Store;return $traceurRuntime.createClass(Store,{},{},BaseStore),assign(Store.prototype,spec),new Store}},{"../Store":56,"object-assign":52}],63:[function(require,module){"use strict";var invariant=function(condition,format,a,b,c,d,e,f){if(!condition){var error;if(void 0===format)error=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var args=[a,b,c,d,e,f],argIndex=0;error=new Error("Invariant Violation: "+format.replace(/%s/g,function(){return args[argIndex++]}))}throw error.framesToPop=1,error}};module.exports=invariant},{}],64:[function(require,module){"use strict";function any(xs,pred){for(var idx=-1,length=xs.length;++idx<length;)if(pred(xs[idx],idx,xs))return!0;return!1}var PENDING_TOKEN="PENDING_TOKEN";module.exports={setPending:function(store){store.pendingToken=PENDING_TOKEN,store.emitChange()},resolve:function(store){store.pendingToken=null,store.emitChange()},anyPending:function(){for(var stores=[],$__0=0;$__0<arguments.length;$__0++)stores[$__0]=arguments[$__0];return any(stores,function(store){return store.pendingToken==PENDING_TOKEN})}}},{}],65:[function(require,module){"use strict";function emptyFunction(){}var warning=emptyFunction;module.exports=warning},{}]},{},[57])(57)});